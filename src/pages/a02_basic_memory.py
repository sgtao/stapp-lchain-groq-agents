...
"""
A basic example of using StreamlitChatMessageHistory
to help LLMChain remember messages in a conversation.
...
View the code of 'streamlit_agent/basic_memory.py' at bellow repository:
...
if prompt := st.chat_input():
    ...
    # Note: new messages are saved
    #       to history automatically by Langchain during run
